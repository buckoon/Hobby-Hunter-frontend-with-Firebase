        ...
        <div className="absolute top-0 w-full h-full flex flex-col justify-center text-white">
            <div className="md:left-[10%] max-w-[1100px] m-auto absolute p-4">
                ...
                <div className="flex  mt-4">
                    <button className=" flex items-center justify-center text-3xl bg-white text-black w-32 h-10 hover:bg-green-600 transition duration-150 ease-in-out border py-2 px-3 rounded-full  "onClick={handleChange}>About </button>
                    {about ? <p></p> :
                   /*impliment framer motion and add  drop-shadow-2xl to things*/  <p className ="max-w-[600px] drop-shadow-2xl py-2 mt-2 rounded-lg text-lg text-white bg-black/60 ">
